...
function Contact() {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "53d14a70-1567-4ff3-91c0-554515375b4b");
    ...
    <div className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
      ...
      <form onSubmit={onSubmit} className=' max-w-2xl mx-auto text-gray-600 pt-8'>
        <div className='flex flex-wrap'>
            ...
            Your Name
                <input type="text" className="w-full border-gray-300 rounded py-3 px-4 mt-2" placeholder='Your Name' name='Name' required/>
                </div>
        
        <div className='w-full md:w-1/2 text-left md:pl-4'>
            Your Email
                <input type="email" className="w-full border-gray-300 rounded py-3 px-4 mt-2" placeholder='Your Email' name='Email' required/>
                </div>
        </div>
